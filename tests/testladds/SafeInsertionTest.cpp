...
TEST(SafeInsertionTest,testInsertionOverlap) {
    ...
    Particle p1 = Particle({6871,0,0},
                           {0,4.8958309146899,5.83462408131549},1);
    Particle p2 = Particle({6870.99577848984,4.89582991243564,5.83462288687537},
                           {-0.00844301944979238,4.89582790671436,5.83462049654983},2);
    Particle p3 = Particle({6871,0,0},
                           {0,4.8958309146899,5.83462408131549},1);
    Particle p4 = Particle({6870.99577848984,4.89582991243564,5.83462288687537},
                           {-0.00844301944979238,4.89582790671436,5.83462049654983},4);
...
TEST(SafeInsertionTest,testCriticalRangeInsertion1){
    ...
    Particle p0 = Particle(position0,
                           {0,4.8958309146899,5.83462408131549},0);
    ...
    std::array<double,3> position1 = autopas::utils::ArrayMath::add(midPoint,
                                           autopas::utils::ArrayMath::mul({1,1,1},
                                                                          autopas::utils::ArrayMath::add(borderVector,epsilon)));
...
TEST(SafeInsertionTest,testCriticalRangeInsertion2){
    ...
    std::array<double,3> position2 = autopas::utils::ArrayMath::add(midPoint,
                                           autopas::utils::ArrayMath::mul({1,1,1},
                                                                          autopas::utils::ArrayMath::sub(borderVector,epsilon)));
...
TEST(SafeInsertionTest,testCriticalRangeInsertion3){
    ...
    std::array<double,3> position3 = autopas::utils::ArrayMath::add(midPoint,
                                           autopas::utils::ArrayMath::mul({-1,-1,1},
                                                                          autopas::utils::ArrayMath::add(borderVector,epsilon)));
...
TEST(SafeInsertionTest,testCriticalRangeInsertion4){
    ...
    std::array<double,3> position4 = autopas::utils::ArrayMath::add(midPoint,
                                           autopas::utils::ArrayMath::mul({-1,-1,1},
                                                                          autopas::utils::ArrayMath::sub(borderVector,epsilon)));
...
TEST(SafeInsertionTest,testCriticalRangeInsertion5){
    ...
    //inside : midPoint + ((l-eps,l-eps,l-eps)*(1,-1,1))
    std::array<double,3> position5 = autopas::utils::ArrayMath::add(midPoint,
                                           autopas::utils::ArrayMath::mul({1,-1,1},
                                                                          autopas::utils::ArrayMath::sub(borderVector,epsilon)));
...
TEST(SafeInsertionTest,testCriticalRangeInsertion6){
    ...
    //inside : midPoint + ((l-eps,l-eps,l-eps)*(-1,-1,-1))
    std::array<double,3> position6 = autopas::utils::ArrayMath::add(midPoint,
                                           autopas::utils::ArrayMath::mul({1,-1,1},
                                                                          autopas::utils::ArrayMath::sub(borderVector,epsilon)));
