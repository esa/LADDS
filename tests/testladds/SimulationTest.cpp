...
TEST_F(SimulationTest, testInsertionOverlap) {
  ...
  const std::vector<Particle> initialSatellites{Particle({6871., 0., 0.}, {0, 4.8958309146899, 5.83462408131549}, 1),
  ...
  const std::vector<Particle> newSatellites{Particle({6871., 0., 0.}, {0, 4.8958309146899, 5.83462408131549}, 1),
                                            Particle({6870.99577848984, 4.89582991243564, 5.83462288687537},
                                                     {-0.00844301944979238, 4.89582790671436, 5.83462049654983},
                                                     4)};
...
TEST_P(SimulationTest, testCheckedInsert) {
  ...
  autopas->addParticle(Particle(testCheckedInsertParticlePos, zeroVec, 0));

  // particle that will be inserted
  Particle p1{posTestParticle, zeroVec, 1};
